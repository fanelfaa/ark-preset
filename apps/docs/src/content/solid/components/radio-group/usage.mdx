...
When the composite component does not provide enough control, import the raw primitive parts via `RadioGroupBase`:

```tsx
import { RadioGroupBase } from "~/components/ui";
```
