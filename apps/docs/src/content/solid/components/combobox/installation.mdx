...
> **Dependencies:** This component imports shared recipes or sub-components from other packages. Make sure the following are also installed: [scroll-area](/docs/components/scroll-area).
