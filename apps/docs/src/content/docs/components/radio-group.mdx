...
| Prop  | Type                  | Default | Description                                                      |
| ----- | --------------------- | ------- | ---------------------------------------------------------------- |
| value | `UseRadioGroupReturn` | —       | Radio group context returned by `useRadioGroup()`. **Required.** |
| class | `string`              | —       | Custom CSS class.                                                |
...
> **Note:** `RadioGroupIndicator` is automatically rendered inside the root component, and `RadioGroupItemHiddenInput` is automatically rendered inside `RadioGroupItemControl`. You do not need to add them manually.
