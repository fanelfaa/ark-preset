...
export const comboboxVariants = tv({
  slots: {
    ...
    positioner: "z-50",
    content:
      "z-50 min-w-[8rem] max-h-60 rounded-md border border-border bg-background p-1 shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    list: "space-y-1",
