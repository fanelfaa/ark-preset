...
export const toastVariants = tv({
  slots: {
    root: 'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border border-border p-6 pr-8 shadow-lg transition-all data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out',
  ...
  variants: {
    variant: {
      ...
      destructive: {
        root: 'destructive group border-destructive bg-destructive text-destructive-foreground',
