...
export const dialogVariants = tv({
  slots: {
    backdrop:
      "fixed inset-0 z-50 bg-black/10 backdrop-blur-sm backdrop-saturate-150 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
