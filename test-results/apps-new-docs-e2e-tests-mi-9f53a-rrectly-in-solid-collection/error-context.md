...
- Name: apps/new-docs/e2e/tests/migration.spec.ts >> Button page renders correctly in solid collection
- Location: apps/new-docs/e2e/tests/migration.spec.ts:15:1
...
Call log:
  - navigating to "/solid/components/button", waiting until "load"
